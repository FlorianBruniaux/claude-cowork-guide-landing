...
const WORKFLOWS_EN: Workflow[] = [
  ...
  { icon: '📊', title: 'Commercial Presentations', desc: 'Structured PowerPoint/Keynote for clients. Includes reusable template workflow from your existing company files.', complexity: 'Intermediate', complexityClass: 'complexity-intermediate', category: 'commercial', url: GUIDE_BASE + 'workflows/presentation-slides.en.md' },
...
const WORKFLOWS_FR: Workflow[] = [
  ...
  { icon: '📊', title: 'Présentations Commerciales', desc: 'PowerPoint/Keynote structurés pour clients. Inclut la création de templates réutilisables depuis vos fichiers existants.', complexity: 'Intermédiaire', complexityClass: 'complexity-intermediate', category: 'commercial', url: GUIDE_BASE + 'workflows/presentation-slides.md' },
