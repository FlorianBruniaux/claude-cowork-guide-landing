...
const LANDING_ENTRIES_EN: SearchEntry[] = [
  ...
  { id: 'page-comparison', title: 'Tool Comparison', keywords: 'comparison cowork claude code copilot chatgpt', category: 'Pages', url: '/compare/', source: 'landing' },
...
const LANDING_ENTRIES_FR: SearchEntry[] = [
  ...
  { id: 'page-comparison', title: 'Comparaison Outils', keywords: 'comparaison cowork claude code copilot chatgpt', category: 'Pages', url: '/fr/compare/', source: 'landing' },
